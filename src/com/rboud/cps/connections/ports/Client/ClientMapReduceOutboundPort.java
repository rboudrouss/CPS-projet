...
public class ClientMapReduceOutboundPort extends AbstractOutboundPort implements MapReduceSyncCI {

  public ClientMapReduceOutboundPort(ComponentI owner) throws Exception {
    super(MapReduceSyncCI.class, owner);
  }

  public ClientMapReduceOutboundPort(String URI, ComponentI owner) throws Exception {
