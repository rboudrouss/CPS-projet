...
public class ClientContentAccessOutboudPort extends AbstractOutboundPort implements ContentAccessSyncCI{

  public ClientContentAccessOutboudPort(ComponentI owner)
      throws Exception {
    super(ContentAccessSyncCI.class, owner);
  }

  public ClientContentAccessOutboudPort(String URI, ComponentI owner)
      throws Exception {
