...
public class NodeParallelMapReduceOutboundPort extends NodeMapReduceAsyncOutboundPort implements ParallelMapReduceCI {

  public NodeParallelMapReduceOutboundPort(ComponentI owner) throws Exception {
    super(owner);
  }
  ...
  public <A extends Serializable, R, I extends MapReduceResultReceptionCI> void parallelReduce(String computationURI,
    ...
    ((ParallelMapReduceCI) this.getConnector()).parallelReduce(computationURI, reductor, combinator, identityAcc,
