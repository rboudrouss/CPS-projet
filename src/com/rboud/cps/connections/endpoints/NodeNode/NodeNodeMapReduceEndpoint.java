...
import com.rboud.cps.connections.connectors.NodeNode.NodeNodeMapReduceConnector;
...
public class NodeNodeMapReduceEndpoint extends BCMEndPoint<MapReduceSyncCI> {
  ...
  public NodeNodeMapReduceEndpoint(String inboundPortURI) {
  ...
  protected MapReduceSyncCI makeOutboundPort(AbstractComponent c, String inboundPortURI) throws Exception {
    ...
    c.doPortConnection(
      port.getPortURI(),
      inboundPortURI,
      NodeNodeMapReduceConnector.class.getCanonicalName()
    );
    return port;
  }
