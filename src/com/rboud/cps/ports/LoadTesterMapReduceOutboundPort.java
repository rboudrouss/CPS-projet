...
public class LoadTesterMapReduceOutboundPort extends AbstractOutboundPort implements MapReduceSyncCI {

  public LoadTesterMapReduceOutboundPort(ComponentI owner) throws Exception {
    super(MapReduceSyncCI.class, owner);
  }

  public LoadTesterMapReduceOutboundPort(String URI, ComponentI owner) throws Exception {
